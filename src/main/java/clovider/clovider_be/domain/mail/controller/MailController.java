...
public class MailController {
    ...
    @PostMapping
    public ApiResponse<String> sendAuthCode(@RequestBody @Valid AuthAccountId request)
    ...
    @PostMapping("/verify")
    public ApiResponse<String> verifyCode(@RequestBody @Valid VerifyCode request) {
