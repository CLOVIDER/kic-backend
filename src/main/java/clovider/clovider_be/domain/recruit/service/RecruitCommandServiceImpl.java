...
public class RecruitCommandServiceImpl implements RecruitCommandService {
    ...
    public AdminResponse.RecruitCreationInfo createRecruit(RecruitCreateRequestDTO requestDTO) {
        ...
        for (RecruitCreateRequestDTO.KindergartenRecruitRequest kindergartenRequest : requestDTO.getKindergartens()) {
            Kindergarten kindergarten = kindergartenRepository.findById(
                            kindergartenRequest.getKindergartenId())
    ...
    private AdminResponse.RecruitCreationInfo createRecruitCreationInfo(List<Recruit> recruits) {
        ...
        List<AdminResponse.KindergartenClassInfo> kindergartenClassInfos = recruitsByKindergarten.entrySet()
                .stream()
                .map(entry -> {
        ...
        RecruitResponse.RecruitDateAndWeightInfo recruitDateAndWeightInfo = toRecruitDateAndWeightInfo(
                recruits.get(0));
    ...
    private AdminResponse.KindergartenClassInfo createKindergartenClassInfo(String kindergartenName,
